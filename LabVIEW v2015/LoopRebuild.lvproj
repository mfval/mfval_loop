...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="2016RefLoopPulseGen_Cleaned.vi" Type="VI" URL="../2016RefLoopPulseGen_Cleaned.vi"/>
		<Item Name="float_switch_physical_channels.ctl" Type="VI" URL="../Input Channel Lists/float_switch_physical_channels.ctl"/>
		<Item Name="2016RefLoopPulseGen_Original.vi" Type="VI" URL="../2016RefLoopPulseGen_Original.vi"/>
		<Item Name="2017RefLoopPulseGen_Summer.vi" Type="VI" URL="../2017RefLoopPulseGen_Summer.vi"/>
		...
		<Item Name="pulse_generator_controls_refnums.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_controls_refnums.ctl"/>
		<Item Name="pulse_generator_data.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data.ctl"/>
		<Item Name="pulse_generator_data.vi" Type="VI" URL="../Utility Sub VIs/pulse_generator_data.vi"/>
		<Item Name="pulse_generator_data_charts.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data_charts.ctl"/>
		<Item Name="pulse_generator_data_charts_refnums.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data_charts_refnums.ctl"/>
		<Item Name="pulse_generator_data_controls.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data_controls.ctl"/>
		<Item Name="pulse_generator_data_controls_refnums.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data_controls_refnums.ctl"/>
		<Item Name="pulse_generator_data_refnums.ctl" Type="VI" URL="../Utility Sub VIs/pulse_generator_data_refnums.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="absolute_pressure.vi" Type="VI" URL="../Input Processing Sub VIs/absolute_pressure.vi"/>
			...
			<Item Name="gage_pressure.vi" Type="VI" URL="../Input Processing Sub VIs/gage_pressure.vi"/>
			<Item Name="GagePressure.vi" Type="VI" URL="../Refrigeration Loop/GagePressure.vi"/>
			<Item Name="line_density.vi" Type="VI" URL="../Input Processing Sub VIs/line_density.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="lvStorage.dll" Type="Document" URL="lvStorage.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="mixture_enthalpy_quality.vi" Type="VI" URL="../Output Processing Sub VIs/mixture_enthalpy_quality.vi"/>
			<Item Name="nilvaiu.dll" Type="Document" URL="nilvaiu.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="output_current_to_flow.vi" Type="VI" URL="../Input Processing Sub VIs/output_current_to_flow.vi"/>
			<Item Name="P_sat_correlation.vi" Type="VI" URL="../Input Processing Sub VIs/P_sat_correlation.vi"/>
			<Item Name="pressure_change.vi" Type="VI" URL="../Input Processing Sub VIs/pressure_change.vi"/>
			<Item Name="PressureChange.vi" Type="VI" URL="../Refrigeration Loop/PressureChange.vi"/>
			...
			<Item Name="pulse_generator_multiheater_refnum_enable_modifier.vi" Type="VI" URL="../Utility Sub VIs/pulse_generator_multiheater_refnum_enable_modifier.vi"/>
			...
			<Item Name="sep_liq_in_pressure.vi" Type="VI" URL="../Input Processing Sub VIs/sep_liq_in_pressure.vi"/>
			...
			<Item Name="temperature_liquid_inlet.vi" Type="VI" URL="../Input Processing Sub VIs/temperature_liquid_inlet.vi"/>
			<Item Name="temperature_liquid_tank.vi" Type="VI" URL="../Input Processing Sub VIs/temperature_liquid_tank.vi"/>
			<Item Name="temperature_vapor_inlet.vi" Type="VI" URL="../Input Processing Sub VIs/temperature_vapor_inlet.vi"/>
			<Item Name="temperature_vapor_tank.vi" Type="VI" URL="../Input Processing Sub VIs/temperature_vapor_tank.vi"/>
			<Item Name="TemperatureLiquidInlet.vi" Type="VI" URL="../Refrigeration Loop/TemperatureLiquidInlet.vi"/>
			<Item Name="TemperatureLiquidTank.vi" Type="VI" URL="../Refrigeration Loop/TemperatureLiquidTank.vi"/>
			<Item Name="TemperatureVaporInlet.vi" Type="VI" URL="../Refrigeration Loop/TemperatureVaporInlet.vi"/>
			<Item Name="TemperatureVaporTank.vi" Type="VI" URL="../Refrigeration Loop/TemperatureVaporTank.vi"/>
			<Item Name="upper_test_section_pressure.vi" Type="VI" URL="../Input Processing Sub VIs/upper_test_section_pressure.vi"/>
			<Item Name="UpperTSPres.vi" Type="VI" URL="../Refrigeration Loop/UpperTSPres.vi"/>
			<Item Name="valve_physical_channels.ctl" Type="VI" URL="../Input Channel Lists/valve_physical_channels.ctl"/>
			<Item Name="vap_in.vi" Type="VI" URL="../Input Processing Sub VIs/vap_in.vi"/>
			<Item Name="vap_tank_vap_in_pressure.vi" Type="VI" URL="../Input Processing Sub VIs/vap_tank_vap_in_pressure.vi"/>
